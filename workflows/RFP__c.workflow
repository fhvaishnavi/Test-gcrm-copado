...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <alerts>
        <fullName>RFP_Account_Email_Alert</fullName>
        <ccEmails>RFPrequests@teladoc.com</ccEmails>
        <description>RFP Account email alert for RFP Account Notification</description>
        <protected>false</protected>
        <recipients>
            <type>owner</type>
        </recipients>
        <senderType>CurrentUser</senderType>
        <template>RFP_Email_Template/RFP_Account_Notification</template>
    </alerts>
    <alerts>
